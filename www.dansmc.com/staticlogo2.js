...
var ddsitelogo={
	setting: {orientation:2, visibleduration:20000, fadeduration:[8000, 8000]}, //orientation=1|2|3|4, duration=millisec or 0, fadedurations=millisecs
	offsets: {x:10, y:10},//offset of logo relative to window corner
	logoHTML: '<a href="http://www.dansmc.com/time_is_near.htm" title="The Time is Near" target="_blank"><img src="MC_fever_200_2.gif" style="width:200px; height:134px; border:0" /></a>', //HTML for logo, which is auto wrapped in DIV w/ ID="mysitelogo"
